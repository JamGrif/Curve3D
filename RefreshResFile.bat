:: Used to refresh resources in the final folder. Ran everytime Curve3DLauncher is launched (only when developing)
...
:: Copy over any UPDATED ONLY resources from project res file to final res file
